...
export class Shadps4Generator extends BaseGenerator {
  ...
  public configure(): void {
    ...
    try {
      const fullscreen = (Config.getEmulatorSetting('shadps4', 'fullscreen') ?? Config.getEmulatorSetting('shadps4', 'forcefullscreen') ?? Config.getEmulatorSetting('shadps4', 'shadps4_fullscreen', 'true')) === 'true';
