...
export class Pcsx2x6Generator extends BaseGenerator {
  public configure(): void {
    ...
    try {
      const fullscreen = (Config.getEmulatorSetting('pcsx2x6', 'fullscreen') ?? Config.getEmulatorSetting('pcsx2x6', 'forcefullscreen') ?? Config.getEmulatorSetting('pcsx2x6', 'pcsx2x6_fullscreen', 'true')) === 'true';
      const aspect = Config.getEmulatorSetting('pcsx2x6', 'ratio') ?? Config.getEmulatorSetting('pcsx2x6', 'pcsx2x6_aspectratio', '16:9');
      const renderer = Config.getEmulatorSetting('pcsx2x6', 'renderer') ?? Config.getEmulatorSetting('pcsx2x6', 'pcsx2x6_renderer', '-1');
