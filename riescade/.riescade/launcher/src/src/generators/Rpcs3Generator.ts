...
export class Rpcs3Generator extends BaseGenerator {
  public configure(): void {
    ...
    try {
      ...
      const renderer = Config.getEmulatorSetting('rpcs3', 'video_driver', 'Vulkan');
      const vsync = Config.getEmulatorSetting('rpcs3', 'vsync', 'Adaptive');
  ...
  public getLaunchCommand(): { executable: string; args: string[] } {
    ...
    const fullscreen = Config.getEmulatorSetting('rpcs3', 'fullscreen', 'true') === 'true';
