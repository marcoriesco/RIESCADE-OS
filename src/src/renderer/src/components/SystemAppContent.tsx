  ...
  return (
    <div className="h-full flex text-white overflow-hidden relative w-full bg-transparent">
      ...
      <div className="flex-1 flex overflow-hidden bg-black/10">
        ...
        {/* Right Details Panel */}
        {selectedGame && (
          <ScrollArea className="w-[20vw] min-w-[300px] bg-black/50 p-6 select-none">
            ...
            <ScrollArea className="text-xs leading-relaxed text-white/60 h-28 pr-1 bg-white/5 p-2 rounded-lg">
              <p>
